...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if (empty($error)) {
        $sql = "UPDATE users SET name = '$name', email = '$email', phone = '$phone', address = '$address', profile_picture = '$profile_picture', password = '$password' WHERE id = $id";
...
<body>
    ...
    <h2 class="mt-4" style="text-align: center;"><strong>Edit</strong></h2>
